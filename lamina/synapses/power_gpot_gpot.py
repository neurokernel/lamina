...
class power_gpot_gpot(BaseSynapse):
    ...
    def update_state(self, buffer, st=None):
        self.update_func.prepared_async_call(self.grid, self.block, st,
        buffer.gpot_buffer.gpudata, buffer.gpot_buffer.ld,
        buffer.gpot_current, buffer.gpot_delay_steps, self.pre.gpudata,
        self.synapse_state_pointer, self.threshold.gpudata,
        self.slope.gpudata, self.power.gpudata, self.saturation.gpudata,
        self.delay.gpudata)
    ...
    def get_update_func(self):
        ...
        func.prepare([np.intp, np.int32, np.int32, np.int32, np.intp,
